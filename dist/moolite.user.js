...
(function (vue) {
  ...
  const _hoisted_1$n = { class: "flex flex-row" };
  ...
  const _hoisted_1$m = { class: "flex flex-row space-x-1 items-center py-2" };
    ...
    setup(__props) {
      ...
      return (_ctx, _cache) => {
        return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
          ...
          vue.unref(hasConfig) && showConfig.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$6, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.plugin.config, (config) => {
              return vue.openBlock(), vue.createBlock(_sfc_main$n, { config }, null, 8, ["config"]);
            }), 256))
          ])) : vue.createCommentVNode("", true)
        ], 64);
      };
  ...
  const _sfc_main$k = {};
  const _hoisted_1$k = { class: "border-divider border-2" };
  function _sfc_render$3(_ctx, _cache) {
    return vue.openBlock(), vue.createElementBlock("hr", _hoisted_1$k);
  }
  const MooDivider = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$3]]);
  ...
  const _sfc_main$j = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(__props) {
      return (_ctx, _cache) => {
        ...
        }, vue.toDisplayString(__props.tab.icon), 9, _hoisted_1$j);
      };
    }
  });
  ...
  const _hoisted_4$6 = { class: "flex flex-col h-full overflow-auto shrink-0 bg-divider" };
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$i, [
          ...
          vue.createElementVNode("div", _hoisted_2$d, [
            activeTab.value > -1 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$8, [
              activeTab.value === 0 ? (vue.openBlock(), vue.createBlock(_sfc_main$l, {
                key: 0,
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(tabs), (tab, index) => {
                return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
                  class: vue.normalizeClass((tab.width ?? defaultPluginWidth) + " h-full")
                }, [
            ...
            vue.createElementVNode("div", _hoisted_4$6, [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(tabs), (tab, index) => {
                return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
                  index === 1 ? (vue.openBlock(), vue.createBlock(_sfc_main$j, {
                    key: 0,
  ...
  class EquipmentExporterPlugin extends MooLitePlugin {
    constructor() {
      ...
      __publicField(this, "description", "Export your equipment details for the Combat Sim - By Void");
      __publicField(this, "tab", {
        icon: "🗡",
        pluginName: this.name,
  ...
  const contributorNames = ["LagunaE", "Sleutelkind"];
  const betaTesterNames = ["JBQ", "knighterd", "Thessaloniki", "Houston"];
  const helperNames = ["Champ", "ML", "Maxion", "hoador"];
        ...
        return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
          vue.createElementVNode("div", _hoisted_2, [
            vue.createElementVNode("h1", {
              class: vue.normalizeClass(["text-lg font-bold transition duration-700 ease-in-out", {
                "hover:text-cyan-300": vue.unref(contributorNames).includes(vue.unref(characterName)),
                "bg-clip-text hover:text-transparent bg-gradient-to-br from-orange-400 to-scarlet-400 to-90% via-orange-600 via-30%": vue.unref(betaTesterNames).includes(vue.unref(characterName)),
                "bg-clip-text hover:text-transparent bg-gradient-to-br from-burble-300 to-burble-400 to-90%": vue.unref(helperNames).includes(vue.unref(characterName))
              }])
            }, " Whisper Manager ", 2)
          ]),
